...
const sendFinalWeeklyReportToGoogleSheetsGCAdG = async (req, res) => {
  try {
    ...
    console.log(
      `Final Guardian Carers Ads Group Keywords weekly report sent to Google Sheets successfully!`
    );
  } catch (error) {
    console.error(
      "Error sending Guardian Carers Ads Group Keywords weekly report to Google Sheets:",
      error
    );
  }
};
