...
const sendFinalWeeklyReportToGoogleSheetsLPCAdG = async (req, res) => {
  try {
    ...
    console.log(
      `Final LP+C Ads Group Keywords weekly report sent to Google Sheets successfully!`
    );
  } catch (error) {
    console.error(
      "Error sending LP+C Ads Group Keywords weekly report to Google Sheets:",
      error
    );
  }
};
